...
val conf = new SparkConf().setAppName("SNAP Data Viz").setMaster("local").set("spark.driver.memory", "2G").addJars("/lib/gs-core-1.3.jar","./lib/gs-algo-1.3.jar", "./lib/gs-ui-1.3.jar", "./lib/jfreechart-1.0.19-demo.jar")
...
FacebookCombinedGraph.writeAsJson("./output/PRnodesFacebookCombinedGraph.json", "./output/PRedgesFacebookCombinedGraph.json")
